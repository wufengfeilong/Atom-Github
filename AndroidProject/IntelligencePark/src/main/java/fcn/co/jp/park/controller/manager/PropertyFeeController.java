...
public class PropertyFeeController extends BaseController {
    ...
    public Object propertyFeeEdit(){
        PageData pd = this.getPageData();
        Map<String, Object> returnMap = null;
        try {
            returnMap = propertyFeeService.propertyFeeEdit(pd);
        } catch (Exception e) {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/propetyList", produces = {"application/json;charset=UTF-8"})
    public Object propertyFeeList() {
        PageData pd = this.getPageData();
        ...
        try {
            ...
            pd.put("numE",10);
            List<PageData> propertyFeeList = propertyFeeService.getPropertyFeeList(pd);
            int count = propertyFeeService.getPropertyFeeListCount();
            ...
            // 设定物业费列表的查询结果
            data.put("listProperty", propertyFeeList);
            // 设定总页数
