...
public class DateUtil {
    ...
    // 年月日时分秒无符号
    private final static SimpleDateFormat sdfTimeNoSign = new SimpleDateFormat("yyyyMMddHHmmss");
    // 年月日时分秒
     ...
     * @return
     */
    public static String getTimeNoSign() {
        return sdfTimeNoSign.format(new Date());
    }
    ...
    public static void main(String[] ags){
        try {
            System.out.println(dateDiff("2016-10-28 17:42:56",getTime(),"yyyy-MM-dd HH:mm:ss","m"));
        } catch (Exception e) {
