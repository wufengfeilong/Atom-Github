package com.fujisoft.test.view;
/**
 * 可以自由移动缩放的图片控件
...
public class ScaleView extends android.support.v7.widget.AppCompatImageView implements OnGlobalLayoutListener, OnScaleGestureListener, OnTouchListener {
