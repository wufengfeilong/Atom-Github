...
public class VideoRangeSeekBar extends View {
    ...
    static final int DEFAULT_RIGHT_THUMB_NORMAL_RES_ID = R.drawable.seekbar_left;
    static final int DEFAULT_RIGHT_THUMB_PRESS_RES_ID = R.drawable.seekbar_left;
    static final int DEFAULT_LEFT_GRADIENT_RES_ID = R.drawable.seekbar_left_mask;
    static final int DEFAULT_RIGHT_GRADIENT_RES_ID = R.drawable.seekbar_left_mask;
    static final int DEFAULT_VIDEO_CLIP_MASK_RES_ID = R.drawable.seekbar_left_mask;
    static final int DEFAULT_INDICATOR_IMAGE_RES_ID = R.drawable.seekbar_left;
