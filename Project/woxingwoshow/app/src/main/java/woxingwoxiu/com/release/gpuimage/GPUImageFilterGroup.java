...
package woxingwoxiu.com.release.gpuimage;
...
import woxingwoxiu.com.release.gpuimage.util.TextureRotationUtil;

import static woxingwoxiu.com.release.gpuimage.GPUImageRenderer.CUBE;
import static woxingwoxiu.com.release.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see woxingwoxiu.com.release.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see woxingwoxiu.com.release.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * woxingwoxiu.com.release.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see woxingwoxiu.com.release.gpuimage.GPUImageFilter#onDraw(int,
    ...
    public void onDraw(final int textureId, final FloatBuffer cubeBuffer,
        ...
        if (mMergedFilters != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (isNotLast) {
                    GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, boundFrameBuffer[0]);
