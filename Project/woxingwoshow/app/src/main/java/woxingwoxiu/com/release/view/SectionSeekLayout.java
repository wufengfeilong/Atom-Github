...
import woxingwoxiu.com.release.videorange.VideoThumbnailTask;
...
public class SectionSeekLayout extends RelativeLayout {
    ...
    private LayoutParams mSectionParams;
    ...
    public void init(long duration, KSYEditKit kit) {
        ...
        mSectionParams = (LayoutParams) mSectionTopView.getLayoutParams();
