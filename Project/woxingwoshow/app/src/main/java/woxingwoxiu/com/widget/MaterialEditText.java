...
public class MaterialEditText extends EditText implements View.OnFocusChangeListener, View.OnTouchListener{
    ...
    private void init(AttributeSet attrs, Context context) {
        ...
        if(mClearTextIcon == null){
            final Drawable drawable = ContextCompat.getDrawable(context, R.drawable.delete);
        ...
        mClearTextIcon.setBounds(-140, 0, mClearTextIcon.getIntrinsicHeight()-120, mClearTextIcon.getIntrinsicHeight()+20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 根据是否有字符长度规定绘制右下角的计数
        if(maxCount!=-1) {
            canvas.drawText(countString.toString(), getScrollX()+getWidth()-getPaddingRight() - getTextWidth(countString.toString(), countPaint), extraBottomPadding, countPaint);
        }
        // 开始edittext原生的绘制
        super.onDraw(canvas);
    ...
    private void correctPaddings() {
        super.setPadding(getPaddingLeft(),0,getPaddingRight()+20,0);
    }
    ...
    public boolean onTouch(View v, MotionEvent motionEvent) {
        int x = (int) motionEvent.getX() + 140;
