...
public class VideoRangeSeekBar extends View {
    ...
    static final int DEFAULT_LEFT_THUMB_NORMAL_RES_ID = R.drawable.album_seekbar;
    static final int DEFAULT_LEFT_THUMB_PRESS_RES_ID = R.drawable.album_seekbar;
    static final int DEFAULT_RIGHT_THUMB_NORMAL_RES_ID = R.drawable.album_seekbar;
    static final int DEFAULT_RIGHT_THUMB_PRESS_RES_ID = R.drawable.album_seekbar;
    ...
    public RangeThumb mLeftThumb;
    public RangeThumb mRightThumb;
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final Context ctx = getContext();
        mMask.draw(canvas);
//        if ((int)(mRangeEnd - mRangeStart) > 5) {
//            mLeftThumb.draw(canvas);
//            mRightThumb.draw(canvas);
//        } else {
//            mLeftThumb = new RangeThumb(ctx, true, mThumbBandHeight, mRangeStart, 0.0f, mThumbWidth, mWidth,
//                    mHeight, mLeftThumbNormalResId, mLeftThumbPressResId);
//
//            mRightThumb = new RangeThumb(ctx, false, mThumbBandHeight, mRangeEnd, 0.0f, mThumbWidth, mWidth,
//                    mHeight, mRightThumbNormalResId, mRightThumbPressResId);
//            mLeftThumb.draw(canvas);
//            mRightThumb.draw(canvas);
//        }
        mLeftThumb.draw(canvas);
...
//        }
    ...
    private void onActionMove(MotionEvent event) {
        ...
        if (null != mRangeBarChangeListener) {
            mRangeBarChangeListener.onActionMove();
        }
    }
