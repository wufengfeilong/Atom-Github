 ...
 */
public class EditTextField extends AppCompatEditText implements View.OnFocusChangeListener, View.OnTouchListener, TextWatcher {
    ...
    private void init(Context context) {
        ...
        mClearTextIcon.setBounds(20, 0, mClearTextIcon.getIntrinsicHeight(), mClearTextIcon.getIntrinsicHeight());
