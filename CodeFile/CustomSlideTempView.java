package com.fujisoft.daikin.view;
...
import com.fujisoft.daikin.R;


/**
 * Created by 860115039 on 2017/02/17.
 */
...
public class CustomSlideTempView extends View {
    ...
    private void init() {
        ...
        Typeface font = Typeface.createFromAsset(assertMgr, "DFYuan-GBOtf-W5.otf");
    ...
    private void draw0Point(Canvas canvas) {
        ...
        if (temp >= minTemp && temp <= maxTemp) {
            ...
            canvas.drawText(getResources().getString(R.string.temp_symbol),x +xsym+ sliderX,y - yoff, paint);
        }
    }
